...
class multiFiboActionManager(Node):
    ...
    def __init__(self):
        ...
        self.load_goals_and_execute_multifibo_subscriber = self.create_subscription(
            ...
            self.load_goals_and_execute_multifibo,
            10)
...
def main(args=None):
    ...
    _multiFiboActionManager = multiFiboActionManager()

    executor = MultiThreadedExecutor()

    rclpy.spin(_multiFiboActionManager, executor=executor)

    _multiFiboActionManager.destroy()
    rclpy.shutdown()
